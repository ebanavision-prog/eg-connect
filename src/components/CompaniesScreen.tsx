            ...
            >
              <div className="p-8">
                <div className="flex justify-between items-center mb-8">
                  ...
                  <button onClick={() => setIsModalOpen(false)} className="p-2 rounded-full hover:bg-surface-container-high transition-all focus-ring-custom" aria-label={t('companies.closeRegistrationModalAria')}>
